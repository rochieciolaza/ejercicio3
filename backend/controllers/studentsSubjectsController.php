...
*
*    Descripción:
*    Este archivo implementa el controlador para la gestión de la tabla intermedia
*    `students_subjects`, que representa las relaciones entre estudiantes y materias.
*    Contiene las funciones necesarias para manejar solicitudes HTTP: GET, POST, PUT y DELETE.
*    Se utiliza junto con `studentsSubjects.php` (modelo) y `studentsSubjectsRoutes.php` (rutas).
*/
